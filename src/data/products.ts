...
export const products: Product[] = [
  {
    ...
    description:
      "Jaguar is a multi-action bio formulation effective against fungal infections, larvae, sucking pests, thrips and flies, while also acting as a growth promoter. Built on natural oils for safe, residue-free protection across cotton, vegetables and horticulture crops.",
  ...
  },
  {
    ...
    tagline: "Bio fungi, larvicide & sucking pest control with growth promotion",
    description:
      "Phantom is a multi-action bio formulation effective against fungal infections, larvae, sucking pests, thrips and flies, while also acting as a growth promoter. Built on natural oils for safe, residue-free protection across cotton, vegetables and horticulture crops.",
    composition: "Bio fungi + Larvicide + Natural oil blend (Growth Promoter)",
    dosage: "1.5–2.0 ml per litre of water",
    targetPests: ["Fungal infections", "Larvae", "Sucking pests", "Thrips", "Whitefly"],
    targetCrops: ["Cotton", "Chilli", "Vegetables", "Soybean", "Fruit crops"],
  ...
  },
  {
    ...
    description:
      "Sumo Fighter is a natural-oil based bio insecticide that delivers strong knockdown of sucking pests, thrips, whiteflies and larval stages. Cleans up infestations without harming beneficial insects, ideal for IPM programs in cotton, chilli and vegetables.",
  ...
  },
  {
    ...
    tagline: "Bio control for sucking pests, thrips, flies & larvae",
    description:
      "Altra Clean is a natural-oil based bio insecticide that delivers strong knockdown of sucking pests, thrips, whiteflies and larval stages. Cleans up infestations without harming beneficial insects, ideal for IPM programs in cotton, chilli and vegetables.",
    composition: "Natural oil based bio insecticide (Sucking pest + Larvicide)",
    dosage: "1.5–2.0 ml per litre of water",
    targetPests: ["Sucking pests", "Thrips", "Whitefly", "Larvae", "Mites"],
    targetCrops: ["Cotton", "Chilli", "Brinjal", "Tomato", "Okra", "Grapes"],
