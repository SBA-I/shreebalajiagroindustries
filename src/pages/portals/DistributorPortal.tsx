    ...
    <Layout>
      <section className="bg-primary py-10">
        <div className="container mx-auto px-4 lg:px-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading text-2xl md:text-3xl font-bold text-primary-foreground">Dealer Dashboard</h1>
            <p className="text-primary-foreground/80 text-sm">Track shipments, download brand assets, and manage your records.</p>
          </div>
        </div>
      </section>
