...
import { ShieldCheck, FileText, Megaphone, Store, Truck, Bug, BookOpen, UserCheck, Receipt, Package, MessageSquare, Users, Boxes, UserCog, Newspaper, Mail, Activity } from "lucide-react";
...
import AdminFieldActivityManager from "@/components/admin/AdminFieldActivityManager";
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        <Tabs defaultValue="verification">
          <TabsList className="flex flex-wrap h-auto gap-1 mb-6 bg-muted/40 p-1 w-full justify-start">
            ...
            <TabsTrigger value="dealers" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Store className="h-4 w-4 shrink-0" /> Dealers</TabsTrigger>
            <TabsTrigger value="field-officers" className="gap-1.5 flex-1 min-w-[140px] justify-start"><UserCog className="h-4 w-4 shrink-0" /> Field Officers</TabsTrigger>
            <TabsTrigger value="field-activity" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Activity className="h-4 w-4 shrink-0" /> Field Activity</TabsTrigger>
            <TabsTrigger value="stock" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Boxes className="h-4 w-4 shrink-0" /> Dealer Stock</TabsTrigger>
            <TabsTrigger value="invoices" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Receipt className="h-4 w-4 shrink-0" /> Invoices</TabsTrigger>
            <TabsTrigger value="dispatch" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Truck className="h-4 w-4 shrink-0" /> Dispatch</TabsTrigger>
            <TabsTrigger value="msds" className="gap-1.5 flex-1 min-w-[140px] justify-start"><FileText className="h-4 w-4 shrink-0" /> MSDS</TabsTrigger>
            <TabsTrigger value="marketing" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Megaphone className="h-4 w-4 shrink-0" /> Marketing</TabsTrigger>
            <TabsTrigger value="pest" className="gap-1.5 flex-1 min-w-[140px] justify-start"><Bug className="h-4 w-4 shrink-0" /> Pest Calendar</TabsTrigger>
            <TabsTrigger value="resources" className="gap-1.5 flex-1 min-w-[160px] justify-start"><BookOpen className="h-4 w-4 shrink-0" /> Resources</TabsTrigger>
          ...
          <TabsContent value="field-activity"><AdminFieldActivityManager /></TabsContent>
