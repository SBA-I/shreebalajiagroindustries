...
const News = () => {
  ...
  return (
    <Layout>
      <SEO
        title="News & Updates — Shree Balaji Agro"
        description="Latest company announcements, product launches, industry advisories, and farmer guidance from Shree Balaji Agro Industries."
        path="/news"
      />
